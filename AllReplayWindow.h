#ifndef ALLREPLAYWINDOW_H
#define ALLREPLAYWINDOW_H
...
class vWidget;
class DeviceTree;
class AllReplayWindow : public QWidget
{
    Q_OBJECT

public:
    AllReplayWindow(std::shared_ptr<VideoControl> vc, DeviceTree* devtree);
